...
// --- Usersettings limit defaultok (ha vannak oszlopok) ---
$defNewsLimit = 8;
$defPerSymbol = 3;
...
$generalLimit = (int)($_GET["limit"] ?? 10);         // general news max
$portfolioTotalLimit = (int)($_GET["limit"] ?? 20);  // portfolio összesen max
$perSymbolLimit = (int)($_GET["perSymbol"] ?? 3);    // 1 tickerre max
...
// Portfolio mód: company-news (utolsó 7 nap)
$to = new DateTime("now");
