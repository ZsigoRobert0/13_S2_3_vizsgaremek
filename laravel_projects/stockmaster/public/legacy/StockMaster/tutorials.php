...
<title>Pénzkút — Oktatóanyagok 3.0</title>
...
<div class="wrap">
  <div class="topbar">
    <div>
      <h1 class="h1">Pénzkút Oktatóanyagok</h1>
      <div class="sub"></div>
  ...
  <div class="layout">
    ...
    <main class="mainCard">
      ...
      <div class="sectionCard">
        ...
        <label class="notesLabel" for="lessonNotes">Ide írd le röviden, mit értettél meg, mit figyeltél meg a Pénzkút felületén, és milyen tanulságot vinnél tovább.</label>
...
function blueprintFromLesson(item){
  ...
  steps.push({title:'Mire figyelj a Pénzkútben?', content:third});

  const summary = bullets.length ? bullets : [
    'Értsd meg a fogalom gyakorlati jelentését.',
    'Kösd össze a tanultakat a Pénzkút felületével.',
  ...
  let practice = [
    {text:'Nyisd meg az adott leckéhez kapcsolódó részt a Pénzkút felületén vagy chartján, és figyeld meg, hogyan jelenik meg a tananyag a gyakorlatban.', hint:'A cél az, hogy a fogalom ne csak elmélet maradjon.'},
  ...
  const quiz = [
    {
      ...
      options: [
        ...
        {text:'A fogalmat érdemes a gyakorlatban és a Pénzkút felületén is értelmezni', correct:true, why:'Ez kapcsolja össze az elméletet a használattal.'},
  ...
  return {
    ...
    heroNotice: 'A cél itt az, hogy az elméletet összekösd a Pénzkút használatával és a saját kereskedési gondolkodásoddal.',
    ...
    steps: [
      {
        ...
        content: `Amikor a Pénzkútben kiválasztasz egy instrumentumot, elsőre árat, mozgást, chartot és gombokat látsz. Ez a felület azonban csak a megjelenítése valaminek, ami mögött valódi piaci és vállalati értelmezés áll.
...
A cél nem az, hogy minden trade előtt fél órán át fundamentumot olvass, hanem hogy legyen legalább minimális mentális képed arról, mit figyelsz. Ez csökkenti a vak kattintgatást és növeli a döntések érettségét.`
      ...
      {
        title: '3. Mire figyelj a Pénzkútben?',
